"""
Django settings for damp_leaf_41420 project.
...
ROOT_URLCONF = 'damp_leaf_41420.urls'
...
WSGI_APPLICATION = 'damp_leaf_41420.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "damp_leaf_41420 API",
    "DESCRIPTION": "API documentation for damp_leaf_41420 App",
    "VERSION": "v1",
}
